            ...
            <div className="container">
                <div className="track-inner">
                    <div className="track-left">
                        <img src={`${import.meta.env.VITE_API_URL}${avatarUrl}`} alt={name} className="track-img" />
                                    ...
                                    artist.map(e => (
                                        <Link to={`/artist/${e._id}`} key={e._id}>
                                            <div className="track__artist-list-wrapper">
                                                <img src={`${import.meta.env.VITE_API_URL}${e.avatarUrl}`} alt={e.name} className="track__artist-list-avatar" />
